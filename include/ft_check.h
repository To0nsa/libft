...
// ─────────────────────────────────────────────────────────────
bool ft_isstrpositive(
    const char* str); ///< Checks if string contains only digits and is > 0
bool ft_is_valid_integer(
    const char* str); ///< Validates C-style signed integer string format
